...
export const PARTIES: Record<PartyCode, Party> = {
  ...
  ERD: {
    ...
    note: "Launched 6 August 2026. Only 17 of 46 items codeable and a third of those inferred. Suppressed from the headline ranking and from the grid by the coverage rule.",
  },
  HTA: {
